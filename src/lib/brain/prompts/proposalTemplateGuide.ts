export const dgProposalTemplateGuide = [
  ...
  "9. Trainers: preserve the selected primary trainer and optional second trainer identities. Never invent or rewrite trainer credentials. The application inserts approved photos and complete profiles deterministically. Long trainer profiles may continue onto extra pages.",
  ...
  "Treat proposalBrief as authoritative. Convert line-separated objectives, topics, tools, included items, and responsibilities into clean arrays. Preserve supplied schedule, trainer identities, payment terms, acceptance deadline, and proposal date without inventing replacements. The authorized DG Academy signatory is always Mr. Hin Sopheap, Executive Director, and is independent of trainer selection.",
