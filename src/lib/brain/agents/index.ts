...
const dgProposalTemplateGuide = [
  "Follow the five-page DG Academy client proposal template for the proposal output:",
  "1. Cover: use proposalBrief.coverHeading when supplied, then [course title], subtitle, certification label, and [client]. Keep cover text concise enough for the fixed cover layout.",
  "Use proposalBrief.coverSubtitle and proposalBrief.certificationLabel on the cover when supplied.",
  ...
  "4. Content Outlines: return exactly four session strings formatted as 'Session N: Short title | bullet; bullet; bullet'. Keep each bullet practical and aligned to the syllabus.",
  "5. Training Methodology: provide concise bullets for theory/practice balance, focused inputs, live demonstrations, exercises, group sharing, local context, and follow-up when relevant.",
  "6. Schedule: course duration, date, time, venue, participant count, and TBC where details are missing.",
  "7. Trainer: use the selected catalog trainer name and title only; never invent or rewrite trainer credentials. The application inserts the approved photo and full profile deterministically.",
  "8. Professional Fee and Logistics: include what the package includes, total professional fee, client responsibilities, billing arrangement, payment instructions, and acknowledgement/acceptance wording.",
  "The DOCX renders only the five-page template sections above. Populate other schema fields conservatively for compatibility, without duplicating or expanding the client proposal.",
