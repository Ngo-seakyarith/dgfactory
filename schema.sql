...
create table if not exists public.training_packages (
  ...
  client_background text not null default '',
  training_need text not null default '',
  expected_learning_outcomes text not null default '',
  content_priorities text not null default '',
  training_methodology text not null default '',
  training_tools_materials text not null default '',
  evaluation_approach text not null default '',
  schedule_date text not null default '',
  schedule_time text not null default '',
  schedule_venue text not null default '',
  trainer_id text not null default '',
  second_trainer_id text not null default '',
  included_items text not null default '',
  client_responsibilities text not null default '',
  billing_arrangement text not null default '',
  ...
  vat_status text not null default 'Excluding VAT' check (
    vat_status in ('Including VAT', 'Excluding VAT')
  ),
